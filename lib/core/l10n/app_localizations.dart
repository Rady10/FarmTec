...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'crop_rotation_desc': 'Rotate crops annually to maintain soil balance and reduce pests.',
      'crop_rotation_recommended_crop': 'Recommended crop: {crop}',
      'crop_rotation_reason': 'Reason: {reason}',
      'crop_rotation_plan': 'Plan: {plan}',
      ...
      'field_current_crop': 'Current Crop',
      'field_soil_health': 'Soil Health (%)',
      'field_predicted_yield': 'Predicted Yield (t/ha)',
      'field_soil_nitrogen': 'Soil Nitrogen (%)',
      'field_soil_soc': 'Soil Organic Carbon (%)',
      'field_soil_ph': 'Soil pH',
      'field_fertilizer_type': 'Fertilizer Type',
      'field_plant_date': 'Planting Date (YYYY-MM-DD)',
      'field_current_date': 'Current Date (YYYY-MM-DD)',
      'hint_lat': '30.0444',
      'hint_lon': '31.2357',
      'hint_year': '2026',
      'hint_crop': 'Wheat',
      'hint_prompt': 'Describe symptoms or ask about the plant...',
      'hint_current_crop': 'Wheat',
      'hint_soil_health': '70',
      'hint_predicted_yield': '4.5',
      'hint_soil_nitrogen': '0.1',
      'hint_soil_soc': '1.5',
      'hint_soil_ph': '7.2',
      'hint_fertilizer_type': 'Urea (46% N)',
      'hint_plant_date': '2025-11-01',
      'hint_current_date': '2025-12-10',
    ...
    'model_result_section_soil_categories': 'Soil Categories',
    'model_result_section_soil_elements': 'Soil Elements',
    ...
    'table_metric': 'Metric',
    'table_value': 'Value',
    'expected_yield_gain': 'Expected Yield Gain',
    'expected_yield_gain_pct': 'Expected Yield Gain (%)',
    'yield_information': 'Yield Information',
    'target_yield': 'Target Yield',
    'yield_gap': 'Yield Gap',
      'model_result_market_forecast': '📈 Forecast:',
      'model_result_market_item': '  • {commodity}: {price}',
      'model_result_section_rotation_plan': 'Multi-Season Rotation Plan',
      'model_result_section_planning_summary': 'Planning Summary',
      'model_result_no_rotation_plan': 'No rotation plan available.',
      'model_result_section_analysis': 'Analysis',
      'model_result_section_recommendation': 'Recommendation',
      'model_result_section_prediction_details': 'Prediction details',
      'model_result_section_irrigation_summary': 'Irrigation summary',
      'model_result_section_soil_health_summary': 'Soil health summary',
      'model_result_section_fertilizer_recommendation': 'Fertilizer recommendation',
      'model_result_section_full_response': 'Full response',
      'model_result_field_recommended_crop': 'Recommended crop:',
      'model_result_field_exact_result': 'Exact result:',
      'model_result_field_reason': 'Reason:',
      'model_result_field_plan': 'Plan:',
      'model_result_field_rotation_sequence': 'Rotation sequence:',
      'model_result_field_amount': 'Amount:',
      'model_result_field_advice': 'Advice:',
      'model_result_field_need': 'Need:',
      'model_result_field_water': 'Water:',
      'model_result_field_crop': 'Crop:',
      'model_result_field_fertilizer': 'Fertilizer:',
      'model_result_field_yield': 'Yield:',
      'model_result_field_unit': 'Unit:',
      'model_result_field_total_profit': 'Total Est. Profit:',
      'model_result_field_soil_nitrogen': 'Soil Nitrogen:',
      'model_result_field_soil_organic_carbon': 'Soil Organic Carbon:',
      'model_result_field_class': 'Class:',
      'model_result_field_confidence': 'Confidence:',
      'model_result_field_reliability': 'Reliability:',
      'model_result_field_season': 'Season:',
      'model_result_field_score': 'Score:',
      'model_result_field_rating': 'Rating:',
      'model_result_field_limiting_factor': 'Limiting factor:',
      'model_result_field_recommendation': 'Recommendation:',
      'model_result_field_nearest_data': 'Nearest data:',
    ...
    'ar': {
      ...
      'crop_rotation': 'تدوير المحاصيل',
      'crop_rotation_desc': 'دوِّر المحاصيل سنويًا للحفاظ على توازن التربة وتقليل الآفات.',
      'crop_rotation_recommended_crop': 'المحصول المقترح: {crop}',
      'crop_rotation_reason': 'السبب: {reason}',
      'crop_rotation_plan': 'الخطة: {plan}',
      ...
      'field_lon': 'خط الطول',
      'field_year': 'السنة',
      'field_crop': 'نوع المحصول',
      'field_prompt': 'السؤال',
      'field_current_crop': 'المحصول الحالي',
      'field_soil_health': 'صحة التربة (%)',
      'field_predicted_yield': 'الإنتاج المتوقع (طن/هكتار)',
      'field_soil_nitrogen': 'النيتروجين في التربة (%)',
      'field_soil_soc': 'الكربون العضوي في التربة (%)',
      'field_soil_ph': 'درجة حموضة التربة',
      'field_fertilizer_type': 'نوع السماد',
      'field_plant_date': 'تاريخ الزراعة (YYYY-MM-DD)',
      'field_current_date': 'التاريخ الحالي (YYYY-MM-DD)',
      'hint_lat': '٣٠٫٠٤٤٤',
      'hint_lon': '٣١٫٢٣٥٧',
      'hint_year': '٢٠٢٦',
      'hint_crop': 'قمح',
      'hint_prompt': 'صف الأعراض أو اطرح سؤالاً عن النبات...',
      'hint_current_crop': 'قمح',
      'hint_soil_health': '٧٠',
      'hint_predicted_yield': '٤٫٥',
      'hint_soil_nitrogen': '٠٫١',
      'hint_soil_soc': '١٫٥',
      'hint_soil_ph': '٧٫٢',
      'hint_fertilizer_type': 'يوريا (٤٦% نيتروجين)',
      'hint_plant_date': '٢٠٢٥-١١-٠١',
      'hint_current_date': '٢٠٢٥-١٢-١٠',
    ...
    'model_result_section_soil_categories': 'فئات التربة',
    'model_result_section_soil_elements': 'مكونات التربة',
    ...
    'table_metric': 'المقياس',
    'table_value': 'القيمة',
    'expected_yield_gain': 'زيادة المحصول المتوقعة',
    'expected_yield_gain_pct': 'زيادة المحصول المتوقعة (%)',
    'yield_information': 'معلومات الإنتاج',
    'target_yield': 'المحصول المستهدف',
    'yield_gap': 'فجوة المحصول',
      'model_result_section_analysis': 'التحليل',
      'model_result_section_recommendation': 'التوصية',
      'model_result_section_prediction_details': 'تفاصيل التنبؤ',
      'model_result_section_irrigation_summary': 'ملخص الري',
      'model_result_section_soil_health_summary': 'ملخص صحة التربة',
      'model_result_section_fertilizer_recommendation': 'توصية التسميد',
      'model_result_section_full_response': 'الاستجابة الكاملة',
      'model_result_section_rotation_plan': 'خطة التدوير متعددة المواسم',
      'model_result_section_planning_summary': 'ملخص التخطيط',
      'model_result_no_rotation_plan': 'لا توجد خطة تدوير متاحة.',
      'model_result_field_recommended_crop': 'المحصول المقترح:',
      'model_result_field_exact_result': 'النتيجة الدقيقة:',
      'model_result_field_crop': 'المحصول:',
      'model_result_field_water': 'الماء:',
      'model_result_field_fertilizer': 'السماد:',
      'model_result_field_yield': 'المحصول:',
      'model_result_field_unit': 'الوحدة:',
      'model_result_field_reason': 'السبب:',
      'model_result_field_plan': 'الخطة:',
      'model_result_field_rotation_sequence': 'تسلسل التدوير:',
      'model_result_field_amount': 'الكمية:',
      'model_result_field_advice': 'النصيحة:',
      'model_result_field_need': 'الاحتياج:',
      'model_result_field_class': 'الفئة:',
      'model_result_field_confidence': 'الثقة:',
      'model_result_field_reliability': 'الموثوقية:',
      'model_result_field_season': 'الموسم:',
      'model_result_field_total_profit': 'إجمالي الربح المتوقع:',
      'model_result_field_soil_nitrogen': 'نيتروجين التربة:',
      'model_result_field_soil_organic_carbon': 'الكربون العضوي في التربة:',
      'model_result_field_score': 'الدرجة:',
      'model_result_field_rating': 'التصنيف:',
      'model_result_field_limiting_factor': 'العامل المحدد:',
      'model_result_field_recommendation': 'التوصية:',
      'model_result_field_nearest_data': 'أقرب بيانات:',
